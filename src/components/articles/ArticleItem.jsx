const ArticleItem = ({ urlToImage, title, publishedAt, handleSingleArticle }) => {
  return (
    <div onClick={handleSingleArticle} className="mt-16 w-[295px] h-52 bg-[#f0faff] rounded-md overflow-hidden relative cursor-pointer group">
      <img src={urlToImage} alt="urlImage" className="w-full object-center group-hover:scale-110 duration-200" />
